...
class SendPlacedTileTest {
    ...
    /**
     * Tests if the state changes correctly for the acting player
     */
    @Test
    fun testState(){
    ...
    /**
     * Tests if the boards match after a tile has been placed
     * (same as in receivedPlacedTileRFromOpponent for redundancy)
    */
